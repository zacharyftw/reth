...
use reth_trie::{
    hashed_cursor::{HashedCursorFactory, InstrumentedHashedCursor},
    ...
    Provider: TrieCursorFactory + HashedCursorFactory,
{
    ...
    where
        TC: reth_trie::trie_cursor::TrieStorageCursor,
        HC: reth_trie::hashed_cursor::HashedStorageCursor<Value = alloy_primitives::U256>,
    {
